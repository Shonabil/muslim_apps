...
@section('content')
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $dzikir->title) }}"
                                ...
                                required placeholder="Masukkan judul dzikir">
                        </div>

                        <div class="mt-5">
                            <label for="content" class="block font-medium text-gray-700 mb-2">Deskripsi / Konten
                                Dzikir</label>
                            <textarea name="content" id="content" rows="4"
                                class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"
                                required placeholder="Masukkan konten lengkap dzikir">{{ old('content', $dzikir->content) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="arabic_text" id="arabic_text" rows="3" dir="rtl"
                                    ...
                                    placeholder="أدخل النص العربي هنا">{{ old('arabic_text', $dzikir->arabic_text) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="latin_translation" id="latin_translation" rows="2"
                                class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"
                                placeholder="Masukkan transliterasi latin">{{ old('latin_translation', $dzikir->latin_translation) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="translation" id="translation" rows="2"
                                class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"
                                placeholder="Masukkan terjemahan bahasa Indonesia">{{ old('translation', $dzikir->translation) }}</textarea>
                        </div>
                        <div class="mt-5">
    <label for="fadhilah" class="block font-medium text-gray-700 mb-2">
        <span class="flex items-center">
    ...
    <textarea name="fadhilah" id="fadhilah" rows="3"
        class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition duration-300"
        placeholder="Masukkan keutamaan dzikir">{{ old('fadhilah', $dzikir->fadhilah) }}</textarea>
</div>
                ...
                <div class="flex justify-between pt-5">
                    <a href="{{ route('admin.dzikir.index') }}"
