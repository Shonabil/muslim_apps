            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 rounded-xl shadow-lg mb-6 p-6 text-white">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-green-200 opacity-50" fill="none"
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-2 text-xs font-medium px-2 py-1 rounded-full bg-emerald-100 text-emerald-800">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.user.index') ?? '#' }}"
                                class="text-sm font-medium text-emerald-600 hover:text-emerald-800">Lihat Semua Pengguna
                                →</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-2 text-xs font-medium px-2 py-1 rounded-full bg-yellow-100 text-yellow-800">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.article.index') ?? '#' }}"
                                class="text-sm font-medium text-yellow-600 hover:text-yellow-800">Kelola Artikel →</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 text-xs font-medium px-2 py-1 rounded-full bg-rose-100 text-rose-800">
                                        {{ $dzikirGrowth >= 0 ? '+' : '' }}{{ $dzikirGrowth }}%
                                    </span>
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.dzikir.index') ?? '#' }}"
                                class="text-sm font-medium text-rose-600 hover:text-rose-800">Kelola Dzikir →</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-2 text-xs font-medium px-2 py-1 rounded-full bg-purple-100 text-purple-800">
                                        {{ $doaGrowth >= 0 ? '+' : '' }}{{ $doaGrowth }}%
                                    </span>
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.doa.index') ?? '#' }}"
                                class="text-sm font-medium text-purple-600 hover:text-purple-800">Kelola Doa →</a>
                        </div>
                    </div>
                </div>
            </div>
